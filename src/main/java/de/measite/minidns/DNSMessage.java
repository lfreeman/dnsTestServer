...
/**
 * A DNS message as defined by rfc1035. The message consists of a header and 4
 * sections: question, answer, nameserver and addition resource record section.
 * A message can either be parsed ({@link DNSMessage#parse(byte[])}) or
 * serialized ({@link DNSMessage#toArray()}).
 */
public class DNSMessage {
    ...
    public static enum OPCODE {
         ...
         * @throws IllegalArgumentException
         *             If the byte value is not in the range 0..15.
         */
    ...
    /**
     * Get the receive timestamp if this message was created via parse. This
     * should be used to evaluate TTLs.
     * 
    ...
    public void setAnswers(Record... answers) {
