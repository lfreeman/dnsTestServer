...
public class Record {
     ...
     * The record type.
     * 
     * @see <a href="http://www.iana.org/assignments/dns-parameters">IANA DNS
     *      Parameters</a>
     */
     ...
     * 
     * @param dis
     *            The DataInputStream positioned at the first record byte.
     * @param data
    ...
    public void parse(DataInputStream dis, byte[] data) throws IOException {
        ...
        case TXT:
            ...
            break;
        case ATTR_STRING:
            this.payloadData = new ATTRSTRING();
            break;
        default:
    ...
    public byte[] toByteArray() {
        if (byteArray == null) {
            ...
            try {
                ...
                // payload
                byte[] buf = payloadData.toByteArray();
                //dos.writeShort(buf.length + 1);
